...
const (
	//queryGetForumUsers = "SELECT u.nickname, u.fullname, u.about, u.email from user_forum " +
	//	"LEFT JOIN users u on user_forum.nickname = u.nickname " +
	//	"where user_forum.forum = $1 "
	//queryGetForumUsers = "SELECT u.nickname, u.fullname, u.about, u.email from users u " +
	//	"LEFT JOIN user_forum uf on u.nickname = uf.nickname " +
	//	"where uf.forum = $1  "
	queryGetForumUsers = "SELECT u.nickname, u.fullname, u.about, u.email from user_forum u " +
		"where u.forum = $1  "
